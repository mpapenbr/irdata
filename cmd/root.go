...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "",
		"config file (default is $HOME/.irdata.yml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".irdata" (without extension).
		viper.AddConfigPath(home)
		viper.AddConfigPath(".")
		viper.SetConfigType("yaml")
		viper.SetConfigName(".irdata")
	}
