...
[![Build Status](https://img.shields.io/github/checks-status/mpapenbr/irdata/main?color=black&style=for-the-badge&logo=github)][github-actions]
...
[![License](https://img.shields.io/github/license/mpapenbr/irdata?color=red&style=for-the-badge)][project-license]
[![Go v1.26](https://img.shields.io/badge/Go-%20v1.26-black?style=for-the-badge&logo=go)][gomod-file]

fechtes data via iRacing data API
...
```sh
git clone https://github.com/mpapenbr/irdata
cd irdata
```
...
After cloning the repository you already changed into the project dir irdata.
...
This section will guide you to setup a fully-functional local copy of `irdata`
...
from [`irdata's` Makefile][makefile-file] (most of which are
OS-independent)!

### Installing dependencies

To install all dependencies associated with `irdata`, run the
command
...
Tests in `irdata` are classified as _fast_ and _slow_ - depending
...
`irdata` is powered by a template generated using [`cookiecutter-go`][cookiecutter-go-link] which is based on [`go-template`][go-template-link]
